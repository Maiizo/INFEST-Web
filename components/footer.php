            ...
            <div class="flex flex-col md:flex-row justify-between md:gap-12 items-center md:items-start space-y-10 md:space-y-0">
                ...
                <div class="flex-[2] w-full space-y-6">
                    ...
                    <div class="flex space-x-4 justify-start">
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/p/DKbTmbAB2DU/?utm_source=ig_web_copy_link&igsh=MTI0Z3B3enBnenJsbw==" class="group">
                        ...
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/?locale=id_ID" class="group">
                        ...
                        <!-- Discord -->
                        <a href="https://discord.com/" class="group">
                        ...
                        <div>
                            ...
                            <ul class="space-y-4">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a href="/views/profile.php" class="group flex items-center text-gray-300 hover:text-teal-400 transition-all duration-300">
                                        <div class="w-2 h-2 bg-orange-400 rounded-full mr-3 group-hover:bg-teal-400 transition-colors"></div>
